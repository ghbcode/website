...
Each topic is covered within a self contained python notebook. In some cases the notebooks contain code using the [scikit-learn library](http://scikit-learn.org/stable/modules/classes.html). To begin I'm noting the main ideas first and updates/revisions will follow.
